        ...
        Expanded(
          child: Padding(
            ...
            child: ElevatedButton(
              ...
              child: const Text('تغيير حالة ', style: TextStyle(fontSize: 12)),
            ),
          ),
        ),
        ...
        Expanded(
          child: Padding(
            ...
            child: ElevatedButton(
              ...
              child: Text(statusChanged ? 'تم تغيير الحالة الى في الطريق' : 'الى الطريق', style: const TextStyle(fontSize: 12)),
            ),
          ),
        ),
